...
public class RundeckTaskConfigurator extends AbstractTaskConfigurator
{
    ...
    public void validate(@NotNull final ActionParametersMap params, @NotNull final ErrorCollection errorCollection)
    {
        ...
        {
            errorCollection.addError("say", textProvider.getText("com.dtolabs.rundeck.plugin.say.error"));
        }
    }
